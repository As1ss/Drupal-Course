...
class __TwigTemplate_10d9bef0fe83f7be6ee3088a49a1b60e extends Template
{
    private $source;
    private $macros = [];
...
<p>{% trans %}You can display the new/updated status of content by creating or editing a view. There is a <em>Has new content</em> field for <em>Content</em> views, which displays the new/updated marker. There is also a <em>Has new content</em> filter, which limits the view to new and updated content.{% endtrans %}</p>", "@help_topics/history.tracking_user_content.html.twig", "C:\\Users\\alexis.lopez\\workflow\\Drupal-Course\\drupal\\web\\core\\modules\\history\\help_topics\\history.tracking_user_content.html.twig");
    }
